...
if __name__ == '__main__':
    ...
    secret_key = 'AE23036C66BCEC2B01C4F01D9AA82E76'
    api_key = '4c98c374-2ff1-4974-b481-960df3d6f613'
    passphrase = 'yuiant000000'
    ...
    result = spotAPI.get_orders_list('all', 'ETH-BTC', limit=100)
